...
public class LogSetup {
     ...
     */
    public LogSetup(String logdir, Level level, boolean isTesting) throws IOException {
        this.logdir = logdir;
        initialize(level, isTesting);
    }

    public LogSetup(String logdir, Level level) throws IOException {
        this(logdir, level, false);
    }

    private void initialize(Level level, boolean isTesting) throws IOException {
